...
class AddToDoActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        resetButton.setOnClickListener {
            ...
            setDefaultDateTime();
            mTitleText!!.setText("") // with all the null safety needed (!!)
        ...
        submitButton.setOnClickListener {
            ...
            val title = this.mTitleText!!.text.toString()
            val priority = this.priority
            val status = this.status
            val date = "" + this.dateView!!.text + " " + this.timeView!!.text

            Log.i(TAG, "Entered setOnClickListener : Date is $date")
